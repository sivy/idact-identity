...
# http://std.dkuug.dk/i18n/iso-639-2.txt
LANGUAGE_CODES_TEXT = """aar	aar	Afar
abk	abk	Abkhazian
ace	ace	Achinese
ach	ach	Acoli
ada	ada	Adangme
...
LANGUAGE_CODE_FOR_NAME = dict((name, code) for code, bib_code, name in
    (line.split('\t', 2) for line in LANGUAGE_CODES_TEXT.split('\n')))


LANGUAGE_NAME_FOR_CODE = dict((v, k) for k, v in LANGUAGE_CODE_FOR_NAME.items())
